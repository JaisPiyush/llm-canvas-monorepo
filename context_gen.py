...
def main():
    ...
    # --- Configuration: Set your include patterns here ---
    # Example: include_patterns = ["src/", "docs/api/"]
    # If left empty, it will try to include everything not ignored.
    include_patterns = [
        "apps/",
        "packages/"
   
    ]
    # To use, uncomment and modify the line above, e.g.:
    # include_patterns = ["src/", "lib/utils"]
    # --- End Configuration ---
